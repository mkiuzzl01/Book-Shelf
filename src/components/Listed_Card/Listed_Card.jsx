const Listed_Card = ({ read }) => {
  ...
  return (
    <div className="border-2 m-4 rounded-lg">
                ...
                <div className="flex justify-between w-full pb-2 space-x-2">
                  <div className="space-y-1">
                    ...
                    <div className="flex space-x-3">
                        <p className=" bg-[#328EFF26] text-[#328EFF] p-1 rounded-lg"><span>Category:</span> {category}</p>
                        <p className="bg-[#FFAC3326] text-[#FFAC33] p-1 rounded-lg"><span>Rating:</span> {rating}</p>
                        <button className="text-white bg-[#23BE0A] px-1 rounded-lg">View Details</button>
                    </div>
                  </div>
                </div>
